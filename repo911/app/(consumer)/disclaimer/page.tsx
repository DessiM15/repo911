...
export default function DisclaimerPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 text-center mb-8">Legal Disclaimer</h1>
      ...
      <div className="prose prose-gray max-w-none space-y-6 text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">No Attorney-Client Relationship</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">General Information Only</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">No Guarantee of Results</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">Consent to Contact</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">Third-Party Attorneys</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">Seek Professional Advice</h2>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 text-sm text-gray-500">
          <p>
            ...
            <Link href="/privacy" className="text-[#4A90D9] underline">Privacy Policy</Link> and{' '}
            <Link href="/terms" className="text-[#4A90D9] underline">Terms of Service</Link>.
          </p>
        </div>
      </div>
    </div>
