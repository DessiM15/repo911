...
export default function TermsPage() {
  return (
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 text-center mb-8">Terms of Service</h1>
      <p className="text-sm text-gray-500 text-center mb-8">Last updated: February 2026</p>

      <div className="prose prose-gray max-w-none space-y-6 text-gray-700 leading-relaxed">
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">1. About Repo911</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">2. No Attorney-Client Relationship</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">3. Consumer Responsibilities</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">4. Attorney Matching</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">7. Dispute Resolution</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">8. Account Termination</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">9. Modifications</h2>
