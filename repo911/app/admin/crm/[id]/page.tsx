  ...
  if (error && !contact) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/admin/crm" className="text-sm text-[#3474BA] dark:text-blue-300 hover:underline mt-2 inline-block">
          Back to CRM
        </Link>
      </div>
    );
    ...
    <div className="max-w-5xl mx-auto space-y-4">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div>
            {lead && (
              <Link href={`/admin/leads/${lead.id}`} className="text-sm text-[#3474BA] dark:text-blue-300 hover:underline">
                View Lead &rarr;
              </Link>
            )}
            {attorney && (
              <Link href={`/admin/attorneys/${attorney.id}`} className="text-sm text-[#3474BA] dark:text-blue-300 hover:underline">
                View Attorney &rarr;
              </Link>
            )}
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex items-center gap-1">
              ...
              <button
                ...
                className="text-xs text-[#3474BA] dark:text-blue-300 hover:underline disabled:opacity-50"
              >
                Add
              </button>
            </div>
